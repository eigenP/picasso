...
2025-05-27 - [Algorithmic Positivity Constraints with Anti-Correlated Signals]
Learning: The unmixing algorithm enforces a strict physical positivity constraint ($U_{ij} \le 0$) because fluorescence crosstalk is strictly additive. When given anti-correlated inputs, it correctly refuses to hallucinate unphysical negative crosstalk, clamping coefficients to 0 and returning an Identity matrix.
